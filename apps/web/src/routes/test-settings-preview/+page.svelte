    ...
    <div class="flex items-center gap-3">
      ...
      <div>
        ...
        <p class="text-muted-foreground mt-1">
          Test page for the live settings preview component
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="space-y-8">
    ...
    <Card>
      <CardContent class="p-6">
        <div class="space-y-4">
          <div>
            <h2 class="text-foreground text-xl font-semibold mb-2">Instructions</h2>
            <p class="text-muted-foreground text-sm leading-relaxed">
              This page tests the SettingsPreview component which shows a live preview of how
              appearance settings affect message appearance. Follow these steps to verify functionality:
            </p>
          </div>

          <ol class="text-muted-foreground text-sm space-y-2 list-decimal list-inside">
            <li>
              <span class="text-foreground">Open Appearance Settings:</span> Navigate to
              <code class="bg-muted px-1.5 py-0.5 rounded text-xs">/app/settings/appearance</code>
              in another tab
            </li>
            <li>
              <span class="text-foreground">Adjust Settings:</span> Change font size, font family,
              or message density settings
            </li>
            <li>
              <span class="text-foreground">Observe Live Preview:</span> Watch the preview below
              update in real-time to reflect your changes
            </li>
            <li>
              <span class="text-foreground">Verify Responsiveness:</span> Ensure the preview
    ...
    <!-- Main Preview -->
    <div>
      <h2 class="text-foreground text-xl font-semibold mb-4">Default Preview</h2>
      <SettingsPreview />
    </div>

    <!-- Custom Title Preview -->
    <div>
      <h2 class="text-foreground text-xl font-semibold mb-4">Custom Title Preview</h2>
      <SettingsPreview
    ...
    <Card>
      <CardContent class="p-6">
        <h2 class="text-foreground text-xl font-semibold mb-4">Current Settings Values</h2>
        <div class="bg-muted/50 rounded-lg p-4 font-mono text-sm">
          <pre class="whitespace-pre-wrap">{JSON.stringify(appearance.currentSettings, null, 2)}</pre>
        </div>
      </CardContent>
    </Card>
    ...
    <Card>
      <CardContent class="p-6">
        <h2 class="text-foreground text-xl font-semibold mb-4">Quick Test Actions</h2>
