...
<div class="container mx-auto max-w-3xl p-6">
  <div class="mb-8">
    ...
    <p class="text-muted-foreground mt-2">
      This page tests the font family selector component
    </p>
  </div>
  ...
  <div class="space-y-8">
    ...
    <div class="border-border bg-muted/50 rounded-lg border p-4">
      ...
      <p class="text-muted-foreground mt-3 text-sm">
        <strong>CSS Font Family:</strong> {currentFontFamily}
      </p>
    </div>
      ...
      <div class="space-y-6">
        <div>
          ...
          <p style="font-family: {currentFontFamily}; font-size: 16px; line-height: 1.6;">
            This is how normal text will appear with your selected font family. The
        ...
        <div>
          ...
          <h4 style="font-family: {currentFontFamily};" class="text-2xl font-bold">
            Heading Text
          </h4>
        </div>
    ...
    <div class="border-border rounded-lg border p-6">
      ...
      <div style="font-family: {currentFontFamily};">
        ...
        <p class="mb-3 text-base leading-relaxed">
          Font families play a crucial role in the readability and aesthetics of
          any application. Each font family has its own character:
        </p>
        <ul class="mb-3 ml-6 list-disc space-y-1 text-base">
          <li>
            <strong>System UI:</strong> Matches your operating system's native
            font for a familiar feel
          </li>
          <li>
            <strong>Sans Serif:</strong> Clean, modern, and highly readable for
            general content
          </li>
          <li>
            <strong>Monospace:</strong> Fixed-width characters ideal for code
