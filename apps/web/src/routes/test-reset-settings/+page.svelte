      ...
      <Card>
        ...
        <CardContent class="space-y-4">
          <ol class="list-decimal space-y-2 pl-4 text-sm">
            ...
            <li>
              Verify the Reset Settings component shows custom settings and enables the reset
              button
            </li>
            <li>
            ...
            <li>
              Verify the dialog shows all settings that will be reset
            </li>
            <li>
              Confirm reset and verify settings return to defaults
            </li>
            <li>
              Use the <strong>Set Default Settings</strong> button to reset manually for
              comparison
            </li>
          </ol>
      ...
      <Card>
        ...
        <CardContent class="space-y-4">
          ...
          <div class="flex items-center justify-between">
            ...
            {#if isAtDefaults()}
              <div class="bg-primary/10 text-primary flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-medium">
                <CheckIcon class="size-3" />
                At Defaults
              </div>
            {:else}
              <div class="bg-destructive/10 text-destructive flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-medium">
                <XIcon class="size-3" />
                Custom Settings
              </div>
            {/if}
        ...
        <CardContent>
          <ul class="space-y-2 text-sm">
            <li class="flex items-start gap-2">
              ...
              <label for="check-1">
                Reset button is disabled when settings are at defaults
              </label>
            </li>
            <li class="flex items-start gap-2">
            ...
            <li class="flex items-start gap-2">
              ...
              <label for="check-3">
                Component displays count of settings that will be reset
              </label>
            </li>
            <li class="flex items-start gap-2">
              <input type="checkbox" class="mt-0.5" id="check-4" />
              <label for="check-4">
                Confirmation dialog opens when reset button is clicked
              </label>
            </li>
            <li class="flex items-start gap-2">
            ...
            <li class="flex items-start gap-2">
              ...
              <label for="check-6">
                Cancel button closes dialog without resetting
              </label>
            </li>
            <li class="flex items-start gap-2">
            ...
            <li class="flex items-start gap-2">
              ...
              <label for="check-8">
                onReset callback is triggered after successful reset
              </label>
            </li>
            <li class="flex items-start gap-2">
              <input type="checkbox" class="mt-0.5" id="check-9" />
              <label for="check-9">
                Preview updates to reflect default settings after reset
              </label>
            </li>
            <li class="flex items-start gap-2">
              <input type="checkbox" class="mt-0.5" id="check-10" />
              <label for="check-10">
                Settings persist in localStorage after reset
              </label>
            </li>
          </ul>
        </CardContent>
