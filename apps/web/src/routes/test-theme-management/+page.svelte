<script lang="ts">
	...
	async function getThemeCount() {
		...
		try {
			const themes = await orpc.theme.getAll();
...
<div class="container mx-auto max-w-7xl px-4 py-8">
	...
	<div class="mb-8">
		...
		<p class="text-muted-foreground">
			Test interface for editing and deleting custom themes
		</p>
	</div>
		...
		<div class="space-y-6 lg:col-span-2">
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Verify the following features are working correctly
					</CardDescription>
				</CardHeader>
		...
		<div class="space-y-6">
			...
			<Card>
				...
				<CardContent class="text-sm space-y-3">
					<div>
						<h4 class="font-semibold mb-1">Setup</h4>
						<ol class="text-muted-foreground list-decimal list-inside space-y-1">
					...
					<div>
						<h4 class="font-semibold mb-1">Test Edit</h4>
						<ol class="text-muted-foreground list-decimal list-inside space-y-1">
					...
					<div>
						<h4 class="font-semibold mb-1">Test Delete</h4>
						<ol class="text-muted-foreground list-decimal list-inside space-y-1">
					...
					<div>
						<h4 class="font-semibold mb-1">Edge Cases</h4>
			...
			<Card>
				...
				<CardContent class="text-xs space-y-2">
					<div>
						<p class="font-mono font-semibold">orpc.theme.getAll()</p>
