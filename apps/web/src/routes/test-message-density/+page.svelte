<script lang="ts">
  ...
  const sampleMessages = [
    ...
    {
      role: 'assistant',
      content: 'The capital of France is Paris. It is known for its art, fashion, gastronomy, and culture.'
    },
    {
      role: 'user',
    ...
    {
      role: 'assistant',
      content: 'Paris is home to iconic landmarks such as the Eiffel Tower, the Louvre Museum, Notre-Dame Cathedral, and the Arc de Triomphe. The city is also known for its cafes and beautiful architecture along the Seine River.'
    }
  ];
...
<div class="container mx-auto max-w-3xl p-6">
  <div class="mb-8">
    ...
    <p class="text-muted-foreground mt-2">
      This page tests the message density selector component
    </p>
  </div>
  ...
  <div class="space-y-8">
    ...
    <div class="border-border bg-muted/50 rounded-lg border p-4">
      ...
      <p class="text-muted-foreground mt-3 text-sm">
        <strong>Message Density:</strong> {currentSettings.messageDensity}
      </p>
    </div>
    ...
    <div class="border-border rounded-lg border p-6">
      <h2 class="text-foreground mb-4 text-xl font-semibold">
        Message Density Preview
      </h2>

      <div
        class="space-y-0"
        style="gap: {densityStyles.messageGap};"
      >
      ...
      <div class="mt-4 border-border border-t pt-4">
        <p class="text-muted-foreground text-sm">
          <strong>Note:</strong> This preview demonstrates how messages will appear
          with the selected density setting. Change the density above to see the difference!
        </p>
      </div>
    </div>
    ...
    <div class="border-border rounded-lg border p-6">
      ...
      <div class="grid gap-4 md:grid-cols-3">
        ...
        <div class="border-border rounded-lg border p-3">
          ...
          <div class="space-y-1">
            <div class="flex items-center gap-2">
              ...
              <div class="h-2 flex-1 rounded bg-muted"></div>
            </div>
            <div class="flex items-center gap-2">
        ...
        <div class="border-border rounded-lg border p-3">
          ...
          <p class="text-muted-foreground mt-2 text-xs">
            Best for: Relaxed viewing experience
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="border-border bg-muted/30 rounded-lg border p-6">
      ...
      <ul class="text-muted-foreground ml-6 list-disc space-y-2 text-sm">
        <li>
          <strong>Compact:</strong> Ideal when you need to see many messages at once,
          such as reviewing long conversations or technical discussions
        </li>
        <li>
          <strong>Comfortable:</strong> Recommended for everyday use, providing a good
          balance between content density and readability
        </li>
        <li>
          <strong>Spacious:</strong> Perfect for casual reading, longer messages,
          or when you prefer a more relaxed interface with breathing room
        </li>
      </ul>
    </div>
  </div>
