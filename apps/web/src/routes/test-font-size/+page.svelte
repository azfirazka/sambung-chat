...
<div class="container mx-auto max-w-3xl p-6">
  <div class="mb-8">
    ...
    <p class="text-muted-foreground mt-2">
      This page tests the font size slider component
    </p>
  </div>
  ...
  <div class="space-y-8">
    ...
    <div class="border-border rounded-lg border p-6">
      ...
      <p style="font-size: {currentSettings.fontSize}px;">
        This is how all the text on the page will look with your selected font
        size. The quick brown fox jumps over the lazy dog. Pack my box with five
        dozen liquor jugs.
      </p>
