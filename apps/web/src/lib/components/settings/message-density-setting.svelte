      ...
      <div class="grid gap-3">
        {#each DENSITY_OPTIONS as option}
          <button
            ...
            class="border-input hover:border-primary hover:bg-accent/50 data-[selected=true]:border-primary data-[selected=true]:bg-primary/5 data-[selected=true]:ring-1 data-[selected=true]:ring-primary relative flex cursor-pointer items-start gap-3 rounded-lg border p-4 text-left transition-all"
          ...
          >
            ...
            <div class="flex-1 space-y-2">
              ...
              <div class="border-border bg-muted/50 mt-2 flex items-center gap-2 rounded border p-2">
                <div
                ...
                <div
                  ...
                  style="padding: {option.spacing.messagePadding}; gap: {option.spacing.messageGap}; display: flex; flex-direction: column; flex: 1;"
                >
