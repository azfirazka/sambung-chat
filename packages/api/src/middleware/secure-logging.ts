 ...
 * - eyJ... (JWT tokens)
 */
const API_KEY_PATTERN = /(sk-[a-zA-Z0-9]{32,}|sk-ant-[a-zA-Z0-9]{32,}|AIza[a-zA-Z0-9_-]{35}|gsk_[a-zA-Z0-9_-]{32,}|eyJ[a-zA-Z0-9_-]+\.[a-zA-Z0-9_-]+\.[a-zA-Z0-9_-]+)/gi;
	...
	try {
		...
		if (error instanceof ORPCError) {
			...
			throw new ORPCError(error.code, {
				...
				data: error.data
					? redactSensitiveData(error.data)
					: undefined,
			});
		}
